...
public class Solution
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        while (true)    // exiting from loop is reached by break comand
        {
            String name = reader.readLine();    // read name
            if (name.isEmpty()) break;

            int age = Integer.parseInt(reader.readLine());  // read age
            int weight = Integer.parseInt(reader.readLine());  // read weight
            int tailLength = Integer.parseInt(reader.readLine());  // read tailLength
